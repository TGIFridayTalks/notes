...
const initialState = [{
  title: 'Dog Park',
  body: 'The City Council announces the opening of a new Dog Park at \
...
period of time at the Hooded Figures. The Dog Park will not harm you.'
  ...
  title: 'Drawback',
  body: 'Now, there is some concern about the fact that, given we are in \
...
And that is a definite drawback, I agree.'
  ...
  body: 'Guns don’t kill people. It’s impossible to be killed by a gun. \
We are all invincible to bullets and it’s a miracle.'
}, {
  title: 'Alligators',
  body: 'And now a brief public service announcement. \
Alligators: can they kill your children? Yes.'
}, {
  title: 'Remember',
  body: 'Remember: if you see something, say nothing, and drink to forget.'
}, {
  title: 'Lonliness',
  body: 'It has occurred to me that I may be the only one able to see it. \
...
and my smooth sonorous voice.'
  ...
  title: 'The Moon',
  body: 'The moon’s weird though, right? It’s there, and there, and then suddenly \
